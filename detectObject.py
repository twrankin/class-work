#!/usr/bin/env python
# Detect any object with the camera. 
...
lower= np.array([0,0,0],np.uint8) # Array (H,S,V) for the lower threshold bound of the HSV image
...
def get_image(CompressedImage):
    ...
    # Needed parameters from outside this function
    global p
    global update
    global start
    global morphOpSize
...
def Init():
    ...
    global pub
    pub = rospy.Publisher('imageLocation', Point, queue_size=5)
